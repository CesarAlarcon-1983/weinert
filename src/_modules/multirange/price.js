...
var Price = function() {
    if ($('input[type="range"]').length > 0) {
        ...
        function updatePriceRangeValues() {
            ...
            priceLabelLow.html('<span>' + valueLow + '</span>');
            priceLabelHigh.html('<span>' + valueHigh + '</span>');
        ...
        function updatePriceLabelPosition(low, high) {
            priceLabelLow.css('left', (low * 100)/50000 + '%');
            priceLabelHigh.css('left', (high * 100)/50000 + '%');
        }
